...
const StoryPage = ({stories, TotalSaved, TotalDrafts, TotalPublished }: Props) => {
                ...
                {stories.map((story) => {
                    ...
                    return(
                        ...
                        <div className='grid md:grid-cols-4 gap-10 grid-cols-2'>
                            ...
                            <Image width={200} height={200} src={imgSrc ? imgSrc :"/no-image.jpg"} alt='Story Image' className=' rounded-lg'/>
                        </div>
                        </Link>
                    )
                })}
...
export const AuthorDetail = ({story}: {story: Story}) => {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            try {
                setuser(await getUser(story.author));
            } catch (error) {
